...
<head>
    ...
    <title>Replica Google Faq</title>
</head>
<body>
...
<?php
    $googleFaqs = [
        ...
        [
            ...
            "par" => "Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.
        ...
        [
            ...
            "par" => "Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:
            ...
            1 - La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:
               ...
               1/a Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.
               1/b Google LLC, con sede negli Stati Uniti, per il resto del mondo.
...
<main>
    <div class="container">
        ...
        //ESEMPIO UTILIZZANDO IL CICLO FOR
            // for ($i=0; $i < count($googleFaqs) ; $i++) { 
            //     $faq = $googleFaqs[$i];
        ...
        //ESEMPIO UTILIZZANDO FOREACH
            foreach ($googleFaqs as $faq) {
                echo "<h1>" . $faq["title"] . "</h1>";
                echo "<p>"  . $faq["par"] . "</p>";
            }
        ?>
